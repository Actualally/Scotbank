...
public final class Constants {
    ...
    public static final String ROUTE_KYC = "/kyc";
    ...
    public static final String TEMPLATE_PORTFOLIO = "portfolio.hbs";
    public static final String TEMPLATE_FORGOT = "forgot.hbs";
    public static final String TEMPLATE_CREATE = "create.hbs";
    public static final String TEMPLATE_KYC = "kyc.hbs";
    ...
    public static final String KYC_BEARER_TOKEN = "Bearer secret-token-12345";
    public static final String KYC_API_URL = "https://api.asep-strath.co.uk/api/kyc";
